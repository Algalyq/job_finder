...
const JobForm = ({ visible, onClose, onSelect }) => {
    const navigation = useNavigation();
    const [modalPosition, setModalPosition] = useState(0);
    const [selectedWorkplace, setSelectedWorkplace] = useState('On-site');
  
    const radioButtonsData = [
      { id: 'On-site', label: 'On-site\nEmployees come to work', value: 'On-site' },
      { id: 'Hybrid', label: 'Hybrid\nEmployees work directly on site or off site', value: 'Hybrid' },
...
const styles = StyleSheet.create({
    radioGroup: {
        ...
        justifyContent: 'space-between', // Distribute space between radio buttons and text
      },
      radioLabel: {
        flex: 1, // Allow text to take up available space
        fontSize: 14,
        marginRight: 20, // Add margin between text and radio buttons
      },
      saveButton: {
